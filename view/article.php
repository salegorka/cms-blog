...
<div class="row justify-content-center">
    <div class="col-sm-8 p-0 article-container d-flex flex-column align-items-center">
        <div class="article-content__name">
            <?= $data['article']['name'] ?>
        </div>
        <?php // var_dump($data['article']) ?>
        <figure class="article-content__img-container">
            <img src="<?= $data['article']['img'] ?>" alt="Картинка статьи" class="article-content__img">
        </figure>
            ...
            <?php foreach($data['comments'] as $comment) : ?>
                <?php if ($comment['approved'] || (!$comment['approved'] && $_SESSION['rights'] >= 2)) : ?>
                    <div class="comment">
                        ...
                        <?php else: ?>
                            <img src="/img/avatars/defaultAvatar.png" alt="Неизвестный аватар" class="comment-img">
                        <?php endif; ?>
